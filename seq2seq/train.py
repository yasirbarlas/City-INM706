...
def main():
    ...
    data_loader = DataLoader(dataset, batch_size = train_settings["batch_size"])
    ...
    # Run training loop
    train(data_loader, encoder, decoder, train_settings["epochs"], logger, dataset.output_lang, print_every = 1, plot_every = 1)
